...
Cover: O - Open habitat (Meadow with dead grass) F - Forest habitat (Ponderosa forest with sparse understory)

Ground: B: Brown, bare ground i.e. meadow or forest floor W: White, snowy ground

Lure: B: Brown wild-type agouti rabbit pelt W: White rabbit pelt

Motion: M: Moving lure S: Stationary model
